...
func RegisterRoutes(e *core.ServeEvent) error {
	...
	e.Router.GET("/zaplab/api/auto-reply-rules", getAutoReplyRules).Bind(auth)
	e.Router.POST("/zaplab/api/auto-reply-rules", postAutoReplyRule).Bind(auth)
	e.Router.PATCH("/zaplab/api/auto-reply-rules/{id}", patchAutoReplyRule).Bind(auth)
	e.Router.DELETE("/zaplab/api/auto-reply-rules/{id}", deleteAutoReplyRule).Bind(auth)
	e.Router.POST("/zaplab/api/auto-reply-rules/{id}/toggle", postAutoReplyRuleToggle).Bind(auth)
